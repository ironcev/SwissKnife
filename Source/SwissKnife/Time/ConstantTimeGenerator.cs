...
namespace SwissKnife.Time
{
    ...
    public class ConstantTimeGenerator : TimeGenerator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstantTimeGenerator"/> class that always generates a constant time.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        /// A date time offset whose date and time is same as the <see cref="ConstantTime"/>.
        /// </returns>
